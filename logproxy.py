...
from proxylab import (core, store, accounts, codex, muse, transforms, canary, writer, warmth,  # noqa: F401
...
_SUBMODULES = (core, store, accounts, codex, muse, transforms, canary, writer, warmth, subs,
